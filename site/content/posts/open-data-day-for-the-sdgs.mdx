...
<Box mb={3}>
  <Img
    ...
    alt="CollaborateUp Formula Working group breaking into teams and using the CollaborateUp formula, each team had an afternoon to scope their problem, identify data sets and develop a pitch to share with the group."
  />
</Box>
